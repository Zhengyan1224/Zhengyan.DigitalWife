...
public class VmdAnimation : IDisposable
{
    ...
    {
        _nodeControllers.ForEach(controller => controller.ResetPlaybackCursor());
        _morphControllers.ForEach(controller => controller.ResetPlaybackCursor());
        _ikControllers.ForEach(controller => controller.ResetPlaybackCursor());
    }
