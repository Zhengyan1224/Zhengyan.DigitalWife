...
public class MMDIkSolver
{
    ...
    public void Solve()
    {
        ...
        for (uint i = 0; i < IterateCount; i++)
        {
            ...
            Vector3 targetPos = IkTarget.Global.GetRowByOneBasedIndex(4).ToVector3();
            Vector3 ikPos = IkNode.Global.GetRowByOneBasedIndex(4).ToVector3();
    ...
    private void SolveCore(uint iteration)
    {
        ...
        for (int i = 0; i < _chains.Count; i++)
        {
            ...
            if (chain.EnableAxisLimit)
            {
                // TODO: Axis-limited IK solving is not implemented yet.
            }
