...
public static class MathHelper
{
    ...
    /// <returns>A decimal number, x, such that 0 鈮?x 鈮?MaxValue.</returns>
    [Pure]
    ...
    /// </summary>
    /// <param name="n">A number that is greater than or equal to MinValue, but less than or equal to MaxValue.</param>
    /// <returns>A double number, x, such that 0 鈮?x 鈮?MaxValue.</returns>
    [Pure]
    ...
    /// </summary>
    /// <param name="n">A number that is greater than or equal to MinValue, but less than or equal to MaxValue.</param>
    /// <returns>A short number, x, such that 0 鈮?x 鈮?MaxValue.</returns>
    [Pure]
    ...
    /// </summary>
    /// <param name="n">A number that is greater than or equal to MinValue, but less than or equal to MaxValue.</param>
    /// <returns>A int number, x, such that 0 鈮?x 鈮?MaxValue.</returns>
    [Pure]
    ...
    /// </summary>
    /// <param name="n">A number that is greater than or equal to MinValue, but less than or equal to MaxValue.</param>
    /// <returns>A long number, x, such that 0 鈮?x 鈮?MaxValue.</returns>
    [Pure]
    ...
    /// </summary>
    /// <param name="n">A number that is greater than or equal to MinValue, but less than or equal to MaxValue.</param>
    /// <returns>A sbyte number, x, such that 0 鈮?x 鈮?MaxValue.</returns>
    [Pure]
    ...
    /// </summary>
    /// <param name="n">A number that is greater than or equal to MinValue, but less than or equal to MaxValue.</param>
    /// <returns>A float number, x, such that 0 鈮?x 鈮?MaxValue.</returns>
    [Pure]
    ...
    /// <returns>An angle, 胃, measured in radians, such that -蟺 鈮?胃 鈮?蟺, and tan(胃) = y / x, where (x, y) is a point in the Cartesian plane.</returns>
    [Pure]
    ...
    /// <returns>If d 鈮?-1 returns -1, if 1 鈮?d returns 1 and if d = 0 returns 0.</returns>
    [Pure]
    ...
    /// <summary>
    /// Normalizes an angle to the range (-蟺, 蟺].
    /// </summary>
    /// <param name="angle">The angle in radians to normalize.</param>
    /// <returns>The normalized angle in the range (-蟺, 蟺].</returns>
    public static float NormalizeRadians(float angle)
    {
        // returns angle in the range [0, 2蟺).
        angle = ClampRadians(angle);

        if (angle > Pi)
        {
            // shift angle to range (-蟺, 蟺]
            angle -= 2 * Pi;
        }
    ...
    /// <summary>
    /// Clamps an angle to the range [0, 2蟺).
    /// </summary>
    /// <param name="angle">The angle to clamp in radians.</param>
    /// <returns>The clamped angle in the range [0, 2蟺).</returns>
    public static float ClampRadians(float angle)
    {
        // mod angle so it's in the range (-2蟺,2蟺)
        angle %= TwoPi;

        if (angle < 0.0f)
        {
            // shift angle to the range [0,2蟺)
            angle += TwoPi;
        }
